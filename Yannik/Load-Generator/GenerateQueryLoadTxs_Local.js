...
const querySampleData = async (numberOfTransaction, sendingRateInMiliSeconds) => {
    ...
    const url = `http://${machinIP}:4000/channels/mychannel/chaincodes/sample_cc?args=["22060090-e21e-4d42-b7c9-1236df12a3a0"]&&peer=peer0.org1.example.com&&fcn=GetCarById`
